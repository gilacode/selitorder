...
Be sure to use an appropriate `type` attribute on all inputs (e.g., `email` for email addressLine1 or `number` for numerical information) to take advantage of newer input controls like email verification, number selection, and more.
...
<form>
  <div class="form-group">
    <label for="exampleInputEmail1">Email addressLine1</label>
...
<form>
  <div class="form-group">
    <label for="exampleFormControlInput1">Email addressLine1</label>
